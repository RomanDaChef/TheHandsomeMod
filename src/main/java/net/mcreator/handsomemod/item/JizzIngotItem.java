...
public class JizzIngotItem extends TheHandsomeModModElements.ModElement {
	@ObjectHolder("the_handsome_mod:jizz_ingot")
	public static final Item block = null;
	public JizzIngotItem(TheHandsomeModModElements instance) {
		super(instance, 28);
	}
