...
public class CopperOreBlock extends TheHandsomeModModElements.ModElement {
	@ObjectHolder("the_handsome_mod:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(TheHandsomeModModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.7f, 10f).lightValue(0).harvestLevel(1)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 9)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(15, 1, 1, 45))));
		}
	}
}
