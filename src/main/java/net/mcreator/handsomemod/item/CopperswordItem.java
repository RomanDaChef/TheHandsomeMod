...
public class CopperswordItem extends TheHandsomeModModElements.ModElement {
	@ObjectHolder("the_handsome_mod:coppersword")
	public static final Item block = null;
	public CopperswordItem(TheHandsomeModModElements instance) {
		super(instance, 54);
	}
