...
import net.mcreator.handsomemod.gui.LiquguiGui;
...
public class LiquifierBlock extends TheHandsomeModModElements.ModElement {
	@ObjectHolder("the_handsome_mod:liquifier")
	public static final Block block = null;
	@ObjectHolder("the_handsome_mod:liquifier")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public LiquifierBlock(TheHandsomeModModElements instance) {
		super(instance, 22);
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Liquifier");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new LiquguiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new LiquguiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
