package net.mcreator.handsomemod;
...
public class TheHandsomeModModVariables {
	public TheHandsomeModModVariables(TheHandsomeModModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("the_handsome_mod", "player_variables"), new PlayerVariablesProvider());
	}
