...
public class CopperArmorItem extends TheHandsomeModModElements.ModElement {
	@ObjectHolder("the_handsome_mod:copper_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("the_handsome_mod:copper_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("the_handsome_mod:copper_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("the_handsome_mod:copper_armor_boots")
	public static final Item boots = null;
	public CopperArmorItem(TheHandsomeModModElements instance) {
		super(instance, 49);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "the_handsome_mod:textures/models/armor/copper__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
