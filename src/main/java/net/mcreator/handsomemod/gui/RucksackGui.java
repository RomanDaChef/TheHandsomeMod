...
public class RucksackGui extends TheHandsomeModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public RucksackGui(TheHandsomeModModElements instance) {
		super(instance, 78);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("rucksack"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("the_handsome_mod:textures/rucksack.png");
		@Override
